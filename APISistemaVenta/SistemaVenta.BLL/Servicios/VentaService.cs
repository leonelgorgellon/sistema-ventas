...
namespace SistemaVenta.BLL.Servicios
{
    public class VentaService : IVentaService
    {
        ...
        public VentaService(IVentasRepositorio ventaRepositorio, IGenericRepositorio<DetalleVenta> detalleVentaRepositorio, IMapper mapper)
        {
        ...
        public async Task<List<VentaDTO>> Historial(string buscarPor, string numeroVenta, string fechaInicio, string fechaFin)
        {
            ...
            try
            {
                if(buscarPor == "fecha")
                {
                    //convertimos fecha inicio fecha de tipo datetime 
