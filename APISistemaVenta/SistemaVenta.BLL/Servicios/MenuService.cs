...
namespace SistemaVenta.BLL.Servicios
{
    public class MenuService : IMenuService
    {
        ...
        public MenuService(IGenericRepositorio<Usuario> usuarioRepositorio, 
            IGenericRepositorio<MenuRol> menuRolRepositorio, 
            IGenericRepositorio<Menu> menuRepositorio, IMapper mapper)
        {
